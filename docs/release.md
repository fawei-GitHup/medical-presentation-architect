...
当前公开仓库为 [fawei-GitHup/medical-presentation-architect](https://github.com/fawei-GitHup/medical-presentation-architect)，版本 `v1.0.0`。下载和安装方式见 README；发布新版本的步骤见 [GitHub 发布指南](github.md)。
